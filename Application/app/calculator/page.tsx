...
export default function CalculatorPage() {
  ...
  const calculateReturns = () => {
    ...
    const totalAnnualExpenses =
      monthlyManagementFee * 12 + repairReserveFund + insuranceFee + (purchasePrice * propertyTax) / 100
    ...
    // 순 임대수입
    const annualNetIncome = annualRentIncome - totalAnnualExpenses - loanPayment
    ...
    // 자본이득 (매각 시)
    const futureValue = purchasePrice * Math.pow(1 + expectedAppreciationRate / 100, holdingPeriod)
  ...
  const getYieldGrade = (yieldValue: number) => {
    if (yieldValue >= 8) return { grade: "우수", color: "bg-green-100 text-green-800" }
    if (yieldValue >= 5) return { grade: "양호", color: "bg-blue-100 text-blue-800" }
    if (yieldValue >= 3) return { grade: "보통", color: "bg-yellow-100 text-yellow-800" }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">수익률 계산기</h1>
              <p className="text-gray-600">부동산 투자 수익률을 정확하게 계산하고 분석해보세요</p>
            </div>
          ...
          <div className="lg:col-span-2">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="results" disabled={!results} className="flex items-center">
                  <BarChart3 className="w-4 h-4 mr-2" />
                  결과
                </TabsTrigger>
                <TabsTrigger value="analysis" disabled={!results} className="flex items-center">
              ...
              <TabsContent value="inputs" className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <Label htmlFor="rentIncreaseRate">임대료 상승률 (%/년)</Label>
                        <Input
                          id="rentIncreaseRate"
                          type="number"
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-gray-900 mb-3">취득 비용</h4>
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900 mb-3">운영 비용 (연간)</h4>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="monthlyManagementFee">관리비 (월, 만원)</Label>
                            <Input
                          ...
                          <div>
                            <Label htmlFor="repairReserveFund">수선충당금 (만원)</Label>
                            <Input
                              id="repairReserveFund"
                              type="number"
                              value={inputs.repairReserveFund}
                              onChange={(e) => handleInputChange("repairReserveFund", e.target.value)}
                              placeholder="5"
                            />
                          </div>
                          <div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-3 gap-4">
                      ...
                      <div>
                        <Label htmlFor="expectedAppreciationRate">예상 시세상승률 (%/년)</Label>
                        <Input
                          id="expectedAppreciationRate"
                          type="number"
                          step="0.1"
                          value={inputs.expectedAppreciationRate}
                          onChange={(e) => handleInputChange("expectedAppreciationRate", e.target.value)}
                          placeholder="3"
                        />
                      </div>
                      <div>
                ...
                <div className="flex justify-center pt-6">
                  <Button size="lg" onClick={calculateReturns} className="px-12">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-sm font-medium text-gray-600">표면 수익률</p>
                              <p className={`text-2xl font-bold ${getYieldColor(results.grossYield)}`}>
                                {results.grossYield.toFixed(2)}%
                              </p>
                            </div>
                            <Badge className={getYieldGrade(results.grossYield).color}>
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-sm font-medium text-gray-600">실질 수익률</p>
                              <p className={`text-2xl font-bold ${getYieldColor(results.netYield)}`}>
                                {results.netYield.toFixed(2)}%
                              </p>
                            </div>
                            <Badge className={getYieldGrade(results.netYield).color}>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className={`text-2xl font-bold ${getYieldColor(results.roi)}`}>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <div className="flex justify-between">
                              ...
                              <span
                                className={`font-semibold ${results.monthlyNetIncome >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                            ...
                            <div className="flex justify-between">
                              ...
                              <span
                                className={`font-semibold ${results.annualNetIncome >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                            ...
                            <div className="flex justify-between">
                              <span className="text-gray-600">총 현금흐름 ({inputs.holdingPeriod}년)</span>
                              <span
                                className={`font-semibold ${results.totalCashFlow >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-between">
                              <span className="text-gray-600">예상 자본이득</span>
                              <span
                                className={`font-semibold ${results.capitalGain >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                            ...
                            <div className="flex justify-between">
                              ...
                              <span
                                className={`font-semibold ${results.totalReturn >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold text-gray-900">
                                {results.totalAcquisitionCost.toLocaleString()}만원
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">연간 운영비용</span>
                              <span className="font-semibold text-gray-900">
                                {results.totalAnnualExpenses.toLocaleString()}만원
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">연간 대출상환액</span>
                              <span className="font-semibold text-gray-900">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-semibold text-gray-900">{results.paybackPeriod.toFixed(1)}년</span>
                            </div>
                          </div>
                        </div>
                      </CardContent>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              <div
                                className={`w-4 h-4 rounded-full ${results.netYield >= 8 ? "bg-green-500" : results.netYield >= 5 ? "bg-blue-500" : results.netYield >= 3 ? "bg-yellow-500" : "bg-red-500"}`}
                              ></div>
                        ...
                        <div className="space-y-4">
                          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                <h4 className="font-medium text-yellow-800 mb-1">주요 리스크 요인</h4>
                          ...
                          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                <h4 className="font-medium text-blue-800 mb-1">투자 권장사항</h4>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-900 mb-1">
                    {inputs.purchasePrice
                      ? (((inputs.monthlyRent * 12) / inputs.purchasePrice) * 100).toFixed(2)
                      : "0.00"}
                    %
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{inputs.monthlyRent}만원</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">연 임대수입</span>
                    <span className="font-medium">{(inputs.monthlyRent * 12).toLocaleString()}만원</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">매입가격</span>
                    <span className="font-medium">{inputs.purchasePrice.toLocaleString()}만원</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                {savedCalculations.length > 0 ? (
                  <div className="space-y-3">
                    {savedCalculations.slice(0, 3).map((calc) => (
                      ...
                      >
                        <div className="font-medium text-sm text-gray-900 mb-1">{calc.name}</div>
                        <div className="text-xs text-gray-500 mb-2">{calc.date}</div>
                        <div className="flex justify-between text-xs">
                          <span className="text-gray-600">수익률</span>
                          <span className={`font-medium ${getYieldColor(calc.results?.netYield || 0)}`}>
                  ...
                  <div className="text-center py-8">
                    ...
                    <div className="text-sm text-gray-500">저장된 계산이 없습니다</div>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  <div className="font-medium text-gray-900 mb-1">표면 수익률</div>
                  <div className="text-gray-600">연간 임대수입 ÷ 매입가격 × 100</div>
                </div>
                <div>
                  <div className="font-medium text-gray-900 mb-1">실질 수익률</div>
                  <div className="text-gray-600">순 임대수입 ÷ 총 투자금액 × 100</div>
                </div>
                <div>
                  <div className="font-medium text-gray-900 mb-1">ROI</div>
                  <div className="text-gray-600">투자 대비 수익률 (자기자본 기준)</div>
                </div>
              </CardContent>
            </Card>
          </div>
