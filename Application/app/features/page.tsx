...
const mainFeatures = [
  {
    icon: BarChart3,
    title: "통합 분석",
    description: "다양한 부동산 데이터를 한눈에 분석하고 투자 기회를 발견하세요",
    features: ["실시간 시장 데이터 분석", "지역별 가격 동향 파악", "투자 수익성 평가", "리스크 분석 및 평가"],
    href: "/analysis",
    color: "bg-blue-500",
  },
  {
    ...
    features: ["표면/실질 수익률 계산", "현금흐름 분석", "ROI 및 IRR 계산", "세금 고려 수익률"],
    href: "/calculator",
    color: "bg-green-500",
  },
  {
    ...
    features: ["즐겨찾기 물건 저장", "가격 변동 알림", "비교 분석 기능", "투자 노트 작성"],
    href: "/favorites",
    color: "bg-red-500",
  },
]
...
const additionalFeatures = [
  {
    icon: MapPin,
    title: "지도 기반 검색",
    description: "직관적인 지도 인터페이스로 원하는 지역의 부동산을 쉽게 찾아보세요",
  },
  {
    icon: TrendingUp,
    title: "시장 동향 분석",
    description: "실시간 시장 데이터와 트렌드 분석으로 투자 타이밍을 놓치지 마세요",
  },
  {
    icon: Shield,
    title: "리스크 평가",
  ...
  },
  {
    icon: Database,
    title: "빅데이터 분석",
    description: "방대한 부동산 데이터를 기반으로 한 정확한 분석 결과를 제공합니다",
  },
]
...
const benefits = [
  ...
  {
    title: "정확한 분석",
    description: "AI와 빅데이터를 활용한 정확하고 객관적인 분석 결과를 제공합니다",
  },
  {
    title: "리스크 관리",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">추가 기능</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">투자 성공을 위한 다양한 부가 기능들</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">부스터를 선택해야 하는 이유</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">전문적인 분석 도구로 투자 성공률을 높이세요</p>
          </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">부스터의 강력한 기능들을 무료로 체험해보세요</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
