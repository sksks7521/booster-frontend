              ...
              <div className="space-y-8 animate-fadeIn">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 mt-2 flex items-center">
                    <AlertTriangle className="w-3 h-3 mr-1" />※ 층수 필터는 현재
                    백엔드에서 적용되지 않습니다 (표시만)
                  </p>
                </div>
                ...
                <div>
                  ...
                  {areaInputMode === "slider" ? (
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between text-xl font-bold text-blue-700">
                        <span className="bg-blue-100 px-4 py-2 rounded-lg">
                          {formatArea(filters.areaRange[0])}
                        </span>
                        <span className="text-gray-400">~</span>
                        <span className="bg-blue-100 px-4 py-2 rounded-lg">
                          {formatArea(filters.areaRange[1])}
                        </span>
                      </div>
                    </div>
                  ) : (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <Label className="text-xl font-bold">🏗️ 건축년도</Label>
                      </div>
                      <RangeToggle
                  ...
                  <div>
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <Label className="text-xl font-bold">⚖️ 매각기일</Label>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex-1 relative">
                        ...
                        <input
                          ...
                          className="w-full pl-14 pr-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-500 focus:border-blue-500 transition-all"
                          onKeyPress={(e) =>
